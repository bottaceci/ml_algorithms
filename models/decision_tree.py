...
# remember to somehow set a numpy random seed for exact reproducibility
...
class Node:
    def __init__(self, 
        ...
        self.left = left
        self.right = right
        self.value = value # None unless it is a leaf node
...
class DecisionTree:
    ...
    def _information_gain(self, y, X_column, thr):
        ...
        # calculate the weighted avg of the entropy of children
        n = len(y)
        n_l, n_r = len(left_idxs), len(right_idxs)
        e_l, e_r = self._entropy(y[left_idxs]), self._entropy(y[right_idxs])
        child_avg_entropy = (n_l/n) * e_l + (n_r/n) * e_r

        # calculate the IG
        information_gain = parent_entropy - child_avg_entropy
